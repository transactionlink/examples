...
* [client/android](client/android/README.md) - Android native app (Kotlin + Jetpack Compose)
* [client/react-native-expo](client/react-native-expo/README.md) - React Native Expo app (iOS & Android)
